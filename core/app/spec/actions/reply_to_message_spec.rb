...
describe ReplyToMessage do
	...
	it 'should post reply with correct root message id when parent root message id is present' do
		input = {:message=>{:id=>-1, :title=>nil, :body=>"Reply", :reply_to_message_id=>1, :user_id=>1}}
		modified_input = {:id=>-1, :title=>nil, :body=>"Reply", :reply_to_message_id=>1, :user_id=>1, :root_message_id=>150}
	...
	it 'should post reply with correct root message id when parent root message id is nil' do
		input = {:message=>{:id=>-1, :title=>nil, :body=>"Reply", :reply_to_message_id=>1, :user_id=>1}}
		modified_input = {:id=>-1, :title=>nil, :body=>"Reply", :reply_to_message_id=>1, :user_id=>1, :root_message_id=>1}
		message_double = double("Message")
